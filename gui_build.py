...
""")
    ...
    # Row 1: DRDO (col1: 1/3, col2: 2/3)
    col1, col2 = st.columns([1, 2])
    with col1:
        st.markdown(
            """
            <div style="background-color: #fff; display: flex; justify-content: center; align-items: center; height: 210px; width: 100%;">
                <img src="https://upload.wikimedia.org/wikipedia/mai/3/3e/DRDO-logo.png" style="max-width: 90%; max-height: 200px;">
            </div>
            """,
    ...
    with col2:
        st.markdown(
            """
<div style="display: flex; height: 210px; align-items: center; justify-content: center;">
    <div style="text-align: center;">
    “This project was conceptualized and developed during a summer internship at the Scientific Analysis Group (SAG), Defence Research and Development Organisation (DRDO), under the valuable guidance and mentorship of <b>Mr. Mohammed Javed</b>.”
    </div>
</div>
            """,
            unsafe_allow_html=True
    ...
    # Row 2: GSV (col3: 1/3, col4: 2/3)
    col3, col4 = st.columns([1, 2])
    with col3:
        st.markdown(
            """
            <div style="background-color: #fff; display: flex; justify-content: center; align-items: center; height: 210px; width: 100%;">
                <img src="https://upload.wikimedia.org/wikipedia/en/d/d2/Gati_Shakti_Vishwavidyalaya_Logo.png" style="max-width: 90%; max-height: 200px;">
            </div>
            """,
            unsafe_allow_html=True
        )
...
<div style="display: flex; height: 210px; align-items: center; justify-content: center;">
    <div style="text-align: center;">
    It was undertaken as a part of the Bachelor of Technology (B.Tech) curriculum in Artificial Intelligence and Data Science at the School of Technology, Gati Shakti Vishwavidyalaya (GSV), Vadodara.
    </div>
</div>
            """,
            unsafe_allow_html=True
    ...
    st.markdown("""
The primary objective of this academic-industry collaborative effort was to provide hands-on experience in the field of adversarial machine learning, fostering practical understanding of vulnerabilities in deep learning models and the methodologies used to evaluate and strengthen model robustness.

*We extend our heartfelt gratitude to the mentors at SAG, DRDO, and the faculty of GSV for their continuous support, expert guidance, and encouragement throughout the course of this project.*
    """)
